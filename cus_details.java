...
public class cus_details extends JFrame implements ActionListener
  {
...
java.awt.Font f=new java.awt.Font("Papyrus",java.awt.Font.BOLD,50);
		...
		java.awt.Font f3=new java.awt.Font("Harrington",java.awt.Font.BOLD,20);
		 ...
		 setSize(1500,1500);
			...
			TitledBorder a=new TitledBorder(new LineBorder(new Color(0,155,0), 2), "-     Customer Details     -", TitledBorder.LEADING,TitledBorder.TOP,null,Color.white);
		...
		b12=new JButton("Menu");
		b13=new JButton("Delete");
		b14=new JButton("Menu");
...
public void actionPerformed(ActionEvent ae)
{
	...
	try{
			Class.forName("com.mysql.jdbc.Driver");
				...
				PreparedStatement ps=co.prepareStatement("select * from cust");
						
				ResultSet re=ps.executeQuery();
                              

				String Co[]={"ID","Name","Contact","Total Bill"};
...
if(ae.getSource()==b13)
		{
			      ...
			      int b;
					...
					PreparedStatement ps=co.prepareStatement("delete from cust where Id=?");
